...
function singkron_sp2d_ke_lokal_skpd(current_data, bulan, status, callback) {
    ...
    var sp2d_data = {};
    sp2d_data.bulan_gaji = current_data.bulan_gaji;
    sp2d_data.bulan_tpp = current_data.bulan_tpp;
    sp2d_data.created_at = current_data.created_at;
    sp2d_data.created_by = current_data.created_by;
    sp2d_data.deleted_at = current_data.deleted_at;
    sp2d_data.deleted_by = current_data.deleted_by;
    sp2d_data.id_bank = current_data.id_bank;
    sp2d_data.id_daerah = current_data.id_daerah;
    sp2d_data.id_jadwal = current_data.id_jadwal;
    sp2d_data.id_pegawai_bud_kbud = current_data.id_pegawai_bud_kbud;
    sp2d_data.id_rkud = current_data.id_rkud;
    sp2d_data.id_skpd = current_data.id_skpd;
    sp2d_data.id_sp_2_d = current_data.id_sp_2_d;
    sp2d_data.id_spm = current_data.id_spm;
    sp2d_data.id_sub_skpd = current_data.id_sub_skpd;
    sp2d_data.id_sumber_dana = current_data.id_sumber_dana;
    sp2d_data.id_tahap = current_data.id_tahap;
    sp2d_data.id_unit = current_data.id_unit;
    sp2d_data.is_gaji = current_data.is_gaji;
    sp2d_data.is_kunci_rekening_sp_2_d = current_data.is_kunci_rekening_sp_2_d;
    sp2d_data.is_pelimpahan = current_data.is_pelimpahan;
    sp2d_data.is_status_perubahan = current_data.is_status_perubahan;
    sp2d_data.is_tpp = current_data.is_tpp;
    sp2d_data.is_transfer_sp_2_d = current_data.is_transfer_sp_2_d;
    sp2d_data.is_verifikasi_sp_2_d = current_data.is_verifikasi_sp_2_d;
    sp2d_data.jenis_gaji = current_data.jenis_gaji;
    sp2d_data.jenis_ls_sp_2_d = current_data.jenis_ls_sp_2_d;
    sp2d_data.jenis_rkud = current_data.jenis_rkud;
    sp2d_data.jenis_sp_2_d = current_data.jenis_sp_2_d;
    sp2d_data.jurnal_id = current_data.jurnal_id;
    sp2d_data.keterangan_sp_2_d = current_data.keterangan_sp_2_d;
    sp2d_data.keterangan_transfer_sp_2_d = current_data.keterangan_transfer_sp_2_d;
    sp2d_data.keterangan_verifikasi_sp_2_d = current_data.keterangan_verifikasi_sp_2_d;
    sp2d_data.kode_skpd = current_data.kode_skpd;
    sp2d_data.kode_sub_skpd = current_data.kode_sub_skpd;
    sp2d_data.kode_tahap = current_data.kode_tahap;
    sp2d_data.metode = current_data.metode;
    sp2d_data.nama_bank = current_data.nama_bank;
    sp2d_data.nama_bud_kbud = current_data.nama_bud_kbud;
    sp2d_data.nama_rek_bp_bpp = current_data.nama_rek_bp_bpp;
    sp2d_data.nama_skpd = current_data.nama_skpd;
    sp2d_data.nama_sub_skpd = current_data.nama_sub_skpd;
    sp2d_data.nilai_materai_sp_2_d = current_data.nilai_materai_sp_2_d;
    sp2d_data.nilai_sp_2_d = current_data.nilai_sp_2_d;
    sp2d_data.nip_bud_kbud = current_data.nip_bud_kbud;
    sp2d_data.no_rek_bp_bpp = current_data.no_rek_bp_bpp;
    sp2d_data.nomor_jurnal = current_data.nomor_jurnal;
    sp2d_data.nomor_sp_2_d = current_data.nomor_sp_2_d;
    sp2d_data.nomor_spm = current_data.nomor_spm;
    sp2d_data.status_aklap = current_data.status_aklap;
    sp2d_data.status_perubahan_at = current_data.status_perubahan_at;
    sp2d_data.status_perubahan_by = current_data.status_perubahan_by;
    sp2d_data.status_tahap = current_data.status_tahap;
    sp2d_data.tahun = current_data.tahun;
    sp2d_data.tahun_gaji = current_data.tahun_gaji;
    sp2d_data.tahun_tpp = current_data.tahun_tpp;
    sp2d_data.tanggal_sp_2_d = current_data.tanggal_sp_2_d;
    sp2d_data.tanggal_spm = current_data.tanggal_spm;
    sp2d_data.transfer_sp_2_d_at = current_data.transfer_sp_2_d_at;
    sp2d_data.transfer_sp_2_d_by = current_data.transfer_sp_2_d_by;
    sp2d_data.updated_at = current_data.updated_at;
    sp2d_data.updated_by = current_data.updated_by;
    sp2d_data.verifikasi_sp_2_d_at = current_data.verifikasi_sp_2_d_at;
    sp2d_data.verifikasi_sp_2_d_by = current_data.verifikasi_sp_2_d_by;
    
    sp2d.data.push(sp2d_data);
    var data_back = {
        message: {
            type: "get-url",
            content: {
